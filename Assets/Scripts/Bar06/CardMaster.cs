...
public class CardMaster : MonoBehaviour
{
    ...
    public void MakeCard()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            cardObject.transform.position = new Vector3(i * -0.3f, -2.2f, 0);
            cardObject.transform.localScale = new Vector3(0.22f, 0.22f, 1);
    ...
    public void hitCard()
    {
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            var cardObject = Instantiate(cardPrefab, transform.position, Quaternion.identity);
            Vector3 move = transform.localPosition;
            cardObject.transform.position = new Vector3(0.3f, -2.2f, 0);
            cardObject.transform.localScale = new Vector3(0.22f, 0.22f, 1);
    ...
    public void MakeCard2()
    {
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            var cardObject = Instantiate(cardPrefab, transform.position, Quaternion.identity);
            Vector3 move = transform.localPosition;
            cardObject.transform.position = new Vector3(-0.3f, 3.6f, 0);
            cardObject.transform.localScale = new Vector3(0.22f, 0.22f, 1);
    ...
    public void MakeCard3()
    {
        ...
        for (int i = 0; i < 1; i++)
        {
            ...
            var cardObject = Instantiate(cardPrefab, transform.position, Quaternion.identity);
            Vector3 move = transform.localPosition;
            cardObject.transform.position = new Vector3(0f, 3.6f, 0);
            cardObject.transform.localScale = new Vector3(0.22f, 0.22f, 1);
